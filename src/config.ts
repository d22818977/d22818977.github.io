...
export const themeConfig: ThemeConfig = {
  ...
  site: {
    ...
    subtitle: '记录思考与生活',
    // site description
    description: 'yichu 的个人博客，记录技术、阅读、思考与生活。',
    // use i18n title/subtitle/description from src/i18n/ui.ts instead of static ones above
    i18nTitle: false, // true | false
    // author name
    author: 'yichu',
    // site url
    url: 'https://d22818977.github.io',
    // base path
  ...
  footer: {
    ...
    links: [
      ...
      {
        name: 'GitHub',
        url: 'https://github.com/d22818977',
      },
      // {
      //   name: 'X',
...
export const heroBackgroundVideoURL = 'https://d8j0ntlcm91z4.cloudfront.net/user_38xzZboKViGWJOttwIXH07lWA1P/hf_20260405_171521_25968ba2-b594-4b32-aab7-f6b69398a6fa.mp4'
export const heroBackgroundImageURL = `${base}/images/site-background/monumental-landscape.png`
